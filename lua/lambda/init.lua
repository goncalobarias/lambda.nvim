...
local DEFAULT_COLORS = {
  ...
  bright_red = "#aa1872",
  bright_green = "#079374",
  bright_yellow = "#106295",
  bright_blue = "#4457a2",
  bright_magenta = "#d71f92",
  bright_cyan = "#8be9fd",
  bright_white = "#ffffff",
  menu = "#21222C",
  visual = "#3E4452",
...
local colors = vim.tbl_deep_extend('force', DEFAULT_COLORS, vim.g.lambda_colors or {})
...
M.apply = function()
    ...
    local isItalic = vim.g.lambda_italic_comment == true
	...
	if(vim.g.lambda_transparent_bg == true) then
	...
	if(vim.g.lambda_show_end_of_buffer == true) then
